...
﻿# simple_romanai_phi3.py
# Copyright RomanAILabs - Daniel Harding
# Simple RomanAI runner with NRL metrics

import time
import subprocess
from pathlib import Path

def run_romanai(model_path, prompt):
    try:
        # Try direct romanai command
        cmd = ["romanai", "run", str(model_path), "--prompt", prompt, "--max-tokens", "150"]
...
def main():
    ...
    print("Starting RomanAI 4D + NRL metrics demo...")
